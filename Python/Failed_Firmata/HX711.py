...
CONVERTED FOR USE WITH PYFIRMATA AND ARDUINO
"""
...
class HX711:
    ...
    # Self being HX711, link being USB connection
    def __init__(self, dout, pd_sck, gain=128):
        ...
        # Set the pin numbers to arduino board
        self.PD_SCK = pd_sck # Setup as input (Have to read)
        self.DOUT = dout     # Setup as output (Have to write)
